console.log('loading aframe-physics-systeme-no-ammo v4');
/* global THREE */
...
const PhysicsSystem = {
  ...
  async init() {
    ...
    console.log("init end of physics 2")
  },
...
//module.exports = module.exports = AFRAME.registerSystem('physics', {AFRAME.registerSystem('physics',PhysicsSystem)
